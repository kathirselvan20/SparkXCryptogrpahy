...
def encrypt(img, data, new_img_name):
    ...
    # image_name = shift_encryption(data, len(data))
    a = new_img_name.split(".")
    print(a)
    newimg.save(new_img_name, str(a[1].upper()))


# Decode the data in the image
def decrypt(label_result, img):
